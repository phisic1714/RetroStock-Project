...
second_frame= Frame(my_canvas,bg='#9495cb',)
...
bg =  ImageTk.PhotoImage( file = "image/snes.jpg")
...
for docs in doc :
   ...
   photo.append(image)
   Button(second_frame,image=photo[phostolistpos], bg = "red",command=g).grid(row=r,column=c,sticky = N, pady = 100,padx = 50)
   if c % 3 == 0:
      c=0
      r+=1
   phostolistpos+=1
